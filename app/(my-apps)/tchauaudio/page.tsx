export default function AppTchauAudio() {
  return (
    <div>
      <h1 className="text-center text-6xl font-serif">
        Parabéns pela conquita!
      </h1>

      <div className="mt-3 text-center font-thin">
        <h2 className="text-2xl">
          Siga o passo a passo abaixo para conseguir conectar a transcrição
          automatica no seu Whastapp
        </h2>

        <h3 className="text-orange-600 text-xl">
          Você pode entrar em contato comigo para qualquer duvida
        </h3>
      </div>
      ...
      <div className="mt-8 space-y-6">
        <div>
          <h3 className="text-2xl ml-3">Instruções iniciais e orientações</h3>
          <div className="space-y-3 mt-2 font-light">
            <p>
              Você vai receber mensagem no seu whatsapp. Pode demorar um
              pouquinho para conseguirmos gerarmos o codigo para você se
              conectar.
            </p>
            <p>
              Fazemos 4 tentativas de gerar o codigo, caso não conseguirmos,
              você vai receber um QRCode para tirar a foto.
            </p>
            <p>Sugerimos fazer os passos num computador no seu whatsapp-web</p>
            <p>
              Caso não consiga, pode mandar a imagem do QRCode para alguem do
              seu lado, para que você tire leia o QRCode a partir do celular de
        ...
        <div>
          <h3 className="text-2xl ml-3">Como conectar</h3>
          <h3>Código XXXX-YYYY ou QRCode ?</h3>
          <div className="space-y-3 mt-2 font-light">
            <p>Caso você receber um codigo, ex: AHDY-MDQT, siga os passos:</p>
            <p>1. Abra o WhastsAPP no seu celular</p>
            <p>
              2. No Android clique nos 3 pontinhos
              <svg
                viewBox=""
                height="20"
                width="18"
            ...
            <p>
              Ou no iPhone nas configurações
              <span aria-hidden="true" data-icon="settings-iphone" className="">
                <svg
                  viewBox="0 0 20 20"
                  height="18"
                  width="18"
            ...
            <p>Clique em "Conectar com numero de telefone"</p>
            <p>Insira o codigo que te enviamos</p>
            <p>
              Caso tenha recebido o QRCode basta tirar a foto a partir de outro
